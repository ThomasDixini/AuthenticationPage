...
export function ImageSelect({ image, setImage }: ImageSelectProps) {
    ...
    <>
      ...
      {image && (
        <div className="w-full bg-blue-900 mt-8 rounded-md p-8 flex flex-col items-center gap-6">
          ...
          <span className="border-2 border-blue-400 py-2 px-4 rounded-full font-bold flex gap-2 items-center">
            Imagem Selecionada {<Check size={24} weight="bold" />}{" "}
          </span>
        </div>
      )}
    </>
